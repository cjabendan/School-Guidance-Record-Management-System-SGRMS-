...
<?php $__env->startSection('content'); ?>
    ...
    <section id="content">
        ...
        <div class="wrapper">
            ...
            <div class="table-management">
                ...
                <div class="search-bar">
                    <div class="table-search">
                        <form method="GET" action="<?php echo e(route('Counselor.appointments.index')); ?>">
            ...
            <div class="table-list" id="appointments-list">
                ...
                <div class="table">
                    <?php echo $__env->make('Counselor.partials.appointment-list', ['appointments' => $appointments], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
    ...
    <?php echo $__env->make('Counselor.Modal.requestApppointmentModal', ['counselors' => $counselors, 
             'types' => $types, 'children' => $children], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('Counselor.Modal.reviewModal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
                ...
                function fetchAppointments(status = 'all', search = '') {
                    ...
                    let url = `<?php echo e(route('Counselor.appointments.index')); ?>?` + params.toString();
...
document.addEventListener('click', function(e) {
    ...
    const card = modal.querySelector('.sgrms-error-card');
...
<?php echo $__env->make('layouts.counselor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\School-Guidance-Record-Management-System-SGRMS\resources\views/Counselor/appointments.blade.php ENDPATH**/ ?>