                    ...
                    <div class="table-table">
                        <?php $__empty_1 = true; $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="table-card">
                                <div class="table-col title"><?php echo e($parent->first_name); ?> <?php echo e($parent->last_name); ?></div>
                                <div class="table-col"><?php echo e($parent->contact_num ?? 'N/A'); ?></div>
                                <div class="table-col"><?php echo e($parent->email); ?></div>
                                <div class="table-col status">
                                    <?php if(is_null($parent->status)): ?>
                                ...
                                <div class="table-col actions">
                                    <button class="view-btn" data-id="<?php echo e($parent->p_id); ?>">  <i class='bx bx-show'></i></button>
                                    <button class="edit-btn" data-id="<?php echo e($parent->p_id); ?>">  <i class='bx bx-edit'></i></button>
                                    <button class="archive-btn" data-id="<?php echo e($parent->p_id); ?>">  <i class='bx bx-archive'></i></button>
                                </div>
                            </div>
