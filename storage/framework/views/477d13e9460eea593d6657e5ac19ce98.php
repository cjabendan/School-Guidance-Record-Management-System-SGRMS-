    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            <?php if(session('success')): ?>
                safeToast('success', <?php echo json_encode(session('success')); ?>);
            <?php endif; ?>

            <?php if(session('error')): ?>
                safeToast('error', <?php echo json_encode(session('error')); ?>);
            <?php endif; ?>

            <?php if(session('warning')): ?>
                safeToast('warning', <?php echo json_encode(session('warning')); ?>);
            <?php endif; ?>

            <?php if($errors->any()): ?>
                // Show first validation error as a toast
                safeToast('error', <?php echo json_encode($errors->first()); ?>);
            <?php endif; ?>
        });
    </script>
