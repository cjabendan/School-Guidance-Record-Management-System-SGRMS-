<section class="about-section" id="about">
    <div class="content">
        <div class="about-left">
            <img src="<?php echo e(asset('images/img/about.jpg')); ?>" alt="About Us">
        </div>
        <div class="about-right">
            <div class="about-row">
                <i class="fi fi-sr-comment-info"></i>
                <h4>Get to know more about us</h4>
            </div>
            <h2>Get to Know SGRMS: Guiding Students, Supporting Futures</h2>
            ...
            <button class="start-btn" onclick="openLoginModal()">Start Now <i
                    class="fi fi-rr-arrow-small-right"></i></button>
        </div>
</section>
<?php /**PATH C:\Users\Administrator\School-Guidance-Record-Management-System-SGRMS\resources\views/landing-sections/about.blade.php ENDPATH**/ ?>