                            ...
                            <div class="table-card">
                                ...
                                <div class="table-col actions" style="display:flex; gap:8px;">
                                    <button type="button" class="view-btn" data-bs-toggle="modal"
                                        data-bs-target="#viewCaseModal<?php echo e($case->case_id); ?>"></button>
                                    <button type="button" class="edit-btn" data-bs-toggle="modal"
                                        data-bs-target="#editCaseModal<?php echo e($case->case_id); ?>"></button>
                                    <button type="button" class="archive-btn"
                                        onclick="if(confirm('Archive this case?')) { document.getElementById('archive-form-<?php echo e($case->case_id); ?>').submit(); }"></button>
