<?php $__env->startSection('title', 'SGRMS - Notifications'); ?>
...
<section id="content">
    ...
    <div class="notification-container">
        ...
        <div class="notification-board">
            ...
            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($list->count()): ?>
                    <h3 class="notif-section-title"><?php echo e($title); ?></h3>
                    <div class="notifications-list">
                        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="notification-item <?php echo e($notification->is_read ? 'read' : 'unread'); ?>"
                                 data-id="<?php echo e($notification->id); ?>"
                                 data-title="<?php echo e($notification->relatedAnnouncement->title ?? 'Announcement'); ?>"
                                 data-description="<?php echo e($notification->relatedAnnouncement->description ?? 'No description available.'); ?>"
                                 data-time="<?php echo e(\Carbon\Carbon::parse($notification->timestamp)->format('F d, Y g:i A')); ?>"
                                 data-category="<?php echo e($notification->relatedAnnouncement->category ?? 'General'); ?>">
            ...
            <?php if(!$new->count() && !$today->count() && !$earlier->count()): ?>
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\School-Guidance-Record-Management-System-SGRMS\resources\views/Student/Notify/notification.blade.php ENDPATH**/ ?>