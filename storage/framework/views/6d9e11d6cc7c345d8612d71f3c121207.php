    ...
    <div class="flex-side">
        <div>
            ...
            <ul class="side-menu top">
                ...
                <!-- Profiling (main link) -->
                <li
                    class="<?php echo e(Request::is('Head/counselors*') || Request::is('Head/users*') || Request::is('Head/students*') ? 'active' : ''); ?>">
                ...
                <!-- Profiling submenu -->
                <ul class="submenu <?php echo e(Request::is('Head/counselors*') || Request::is('Head/users*') || Request::is('Head/students*') ? 'active' : ''); ?>"
                    ...
                    <li class="<?php echo e(Request::is('Head/students*') ? 'active' : ''); ?>">
                     ...
                     <li class="<?php echo e(Request::is('Head/users*') ? 'active' : ''); ?>">
                        <a href="<?php echo e(url('Head/users')); ?>">
                            <i class="fi fi-sr-users"></i>
