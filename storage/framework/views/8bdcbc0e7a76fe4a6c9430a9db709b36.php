<section class="home" id="home">
    ...
    <div class="video-overlay">
        <video class="video-slide active" src="<?php echo e(asset('video/landing.mp4')); ?>" muted></video>
        <video class="video-slide" src="<?php echo e(asset('video/parent.mp4')); ?>" muted></video>
        <video class="video-slide" src="<?php echo e(asset('video/appointment.mp4')); ?>" muted></video>
        <video class="video-slide" src="<?php echo e(asset('video/gabi.mp4')); ?>" muted></video>
        <video class="video-slide" src="<?php echo e(asset('video/program.mp4')); ?>" muted></video>
    </div>
