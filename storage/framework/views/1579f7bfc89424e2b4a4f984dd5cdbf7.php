                    ...
                    <div class="filters">
                            <select id="counselor-filter">
                                ...
                                <?php $__currentLoopData = $counselors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $counselor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($counselor->id); ?>" <?php echo e((string)request('counselor_id') === (string)$counselor->id ? 'selected' : ''); ?>>
                                        <?php echo e($counselor->first_name); ?> <?php echo e($counselor->last_name); ?>
