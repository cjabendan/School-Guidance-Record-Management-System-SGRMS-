<div class="notification-wrapper" wire:poll.3s="pollNotifications">
    ...
    <!--[if BLOCK]><![endif]--><?php if($showDropdown): ?>
            ...
            <div class="notificationDropdownContent">
                <div class="notify-list" style="overflow:visible; max-height:none;">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        )); ?>?notify_id=<?php echo e($notification['id'] ?? ''); ?>"
                        class="notify-item <?php echo e(isset($notification['is_read']) && $notification['is_read'] ? 'read' : 'unread'); ?>"
                        style="text-decoration:none; color:inherit;"
                        data-notify-id="<?php echo e($notification['id'] ?? ''); ?>"
                        wire:key="notification-dropdown-<?php echo e($notification['id']); ?>">
                            <span class="notify-icon">📢</span>
                            <div>
                                <p class="notify-text <?php echo e(isset($notification['is_read']) && $notification['is_read'] ? 'notify-text-read' : ''); ?>">
                                    <?php echo e($notification['message']); ?>

                                </p>
                                <small class="notify-time">
                                    <?php echo e(isset($notification['timestamp'])
                ...
                <!--[if BLOCK]><![endif]--><?php if(!$showAll && count($notifications) >= 10): ?>
...
<?php /**PATH C:\Users\Administrator\School-Guidance-Record-Management-System-SGRMS\resources\views/livewire/notification-dropdown.blade.php ENDPATH**/ ?>