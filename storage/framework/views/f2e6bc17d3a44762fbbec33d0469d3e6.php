                ...
                <div id="cases-list">
                    <div class="table">
                        <?php $__empty_1 = true; $__currentLoopData = $cases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="table-card" data-id="<?php echo e($case->case_id); ?>">
                                ...
                                <div class="table-col actions" style="display:flex; gap:8px;">
                                    <button type="button" class="view-btn" data-sid="<?php echo e($case->case_id); ?>" data-bs-toggle="modal"
                                        data-bs-target="#viewCaseModal<?php echo e($case->case_id); ?>"><i class='bx bx-show'></i></button>
                                    <button type="button" class="edit-btn" data-sid="<?php echo e($case->case_id); ?>" data-bs-toggle="modal"
        ...
        (function(){
            ...
            document.addEventListener('DOMContentLoaded', function(){
                ...
                if (confirmBtn) confirmBtn.addEventListener('click', function(){
                    ...
                    const archiveUrl = '<?php echo e(url("/Head/cases")); ?>' + '/' + currentArchiveCaseId + '/archive';
