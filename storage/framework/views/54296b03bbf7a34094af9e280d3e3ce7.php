<div class="settings-form">
    ...
    <div class="flex-1">
        <div class="settings-profile-img-wrapper">
            <img id="visibleProfileImage" src="<?php echo e(asset('images/user/' . Auth::user()->profile_image)); ?>" alt="User-Profile"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!--[if BLOCK]><![endif]--><?php if(isset($toastPayload) && $toastPayload): ?>
        <script>
            (function(){
                var payload = <?php echo json_encode($toastPayload, 15, 512) ?>;
                var attempts = 0;
                function tryShow() {
                    attempts++;
                    if (typeof createToast === 'function') {
