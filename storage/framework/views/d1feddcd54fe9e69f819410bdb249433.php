    ...
    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="table-card" data-id="<?php echo e($row->s_id); ?>">
            ...
            <div class="table-col tittle">
                <img src="<?php echo e(asset('images/user/' . ($row->profile_image ?? 'default.jpg'))); ?>" alt="student-pfp" class="profile-thumb" data-sid="<?php echo e($row->s_id); ?>" data-img="<?php echo e($row->profile_image ?? 'default.jpg'); ?>">
                <?php echo e($name); ?></div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Administrator\School-Guidance-Record-Management-System-SGRMS\resources\views/Head/partials/student_table.blade.php ENDPATH**/ ?>