<div class="container">
    <a href="<?php echo e(url('/?login=true')); ?>" class="back-btn"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
    ...
    <div class="card">
        <div class="content">
            ...
            <div class="content-body">
                <div class="left">
                    <img src="<?php echo e(asset('images/icons/email-pending.png')); ?>" alt="Email Pending Icon" class="icon">
                </div>
                <div class="right">
                    ...
                    <p class="email">
                        <a href="https://mail.google.com/mail/u/0/#inbox"
                            ...
                            <?php echo e(session('registered_email')); ?>
...
<?php /**PATH C:\Users\Administrator\School-Guidance-Record-Management-System-SGRMS\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>