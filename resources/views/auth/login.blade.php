<div class="login-modal">
    <div class="modal">
        <div class="modal-left">
            <img class="modal-image" alt="Image" src="{{ asset('images/img/login2.png') }}"/>
        </div>
        <div class="modal-right">
            ...
            <form action="{{ url('login') }}" method="POST">
                ...
                <div class="input-box" style="position:relative;">
                    <input type="text" name="username" class="input-box" placeholder="Email or Student ID" value="{{ old('username') }}">
