...
@section('content')
    ...
    <section id="content">
        ...
        <div class="wrapper">
            ...
            <div class="table-list" id="appointments-list">
                ...
                <div class="table">
                    @include('Parent.partials.appointment-list', ['appointments' => $appointments])
                </div>
            </div>
    ...
    @include('Parent.modal.requestApppointmentModal', ['counselors' => $counselors, 'types' => $types, 'children' => $children])
    @include('Parent.modal.reviewModal')
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
                ...
                function fetchAppointments(status = 'all', search = '') {
                    ...
                    let url = `{{ route('Parent.appointments.index') }}?` + params.toString();
