...
<div id="counselingModal" class="modal-counseling">
    <div class="modal-content-counseling">
        ...
        <form id="counselingForm" method="POST" action="{{ $storeRoute }}">
            @csrf
...
<script>
    ...
    (function(){
        ...
        input.addEventListener('input', function(e){
            ...
            t = setTimeout(()=>{
                fetch("{{ route('students.search') }}?q="+encodeURIComponent(q), { credentials: 'same-origin' })
                    .then(r => r.json())
                    .then(list => {
                        box.innerHTML = '';
