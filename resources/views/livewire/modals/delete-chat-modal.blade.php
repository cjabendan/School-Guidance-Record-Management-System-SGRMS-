<div>
    @if ($showDeleteModal)
        <div class="delete-chat-modal-overlay" x-data="{ animating: true }" @keydown.escape="@this.call('closeModal')">
                ...
                <div class="delete-chat-modal-content">
                    ...
                    <div class="delete-chat-modal-body">
                        ...
                        <p class="delete-chat-modal-subtitle">
                            This will permanently delete all messages with <strong>{{ $chatUserName }}</strong>. This action cannot be undone.
                        </p>
                    ...
                    <div class="delete-chat-modal-footer">
                        ...
                        <button type="button" wire:click="confirmDelete"
                            class="delete-chat-btn-delete {{ $deleteConfirmed ? '' : 'disabled' }}"
                            {{ $deleteConfirmed ? '' : 'disabled' }} wire:loading.attr="disabled">
