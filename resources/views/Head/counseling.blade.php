                    ...
                    <div class="table">
                        @forelse($counselings as $counseling)
                            <div class="table-card">
                                ...
                                <div class="table-col title">{{ $counseling->student_name ?? 'N/A' }}</div>
                                <div class="table-col">{{ optional($counseling->created_at)->format('Y-m-d H:i') }}</div>
                                ...
                                <div class="table-col actions">
                                    ...
                                    <form method="POST" action="{{ url('Head/counseling/'.$counseling->note_id) }}" style="display:inline-block;" class="archive-form">
                                        @csrf
                                        @method('DELETE')
