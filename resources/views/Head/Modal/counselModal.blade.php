            ...
            <div class="modal-content add-modal-content pro-add-modal">
                ...
                <form id="addCounselorForm" method="POST" action="{{ route('Head.counselors.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-row image-name-row">
                        <div class="image-col">
                            <img id="counselorImage" src="{{ asset('images/user/default.jpg') }}" data-default="{{ asset('images/user/default.jpg') }}" alt="Counselor Image" class="student-image-box pro-add-image">
...
<!------------------------------------------------------------------------>
        ...
        <div id="viewCounselorModal" class="modal" style="display:none;">
            <div class="modal-content add-modal-content pro-add-modal">
                ...
                <div class="pro-add-buttons">
                    <button type="button" class="pro-add-save" id="editCounselorBtn">Edit</button>
                </div>
            </div>
        </div>