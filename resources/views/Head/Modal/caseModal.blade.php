                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="severity" required>
                                    ...
                                    <option value="Intermediate"
                                        {{ $case->severity == 'Intermediate' ? 'selected' : '' }}>Intermediate</option>
                                    <option value="Severe" {{ $case->severity == 'Severe' ? 'selected' : '' }}>Severe
                                    </option>
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="status" required>
                                    ...
                                    <option value="Under Investigation"
                                        {{ $case->status == 'Under Investigation' ? 'selected' : '' }}>Under Investigation
                                    </option>
                                    <option value="Resolved" {{ $case->status == 'Resolved' ? 'selected' : '' }}>Resolved
                                    </option>
                                </select>
                            </div>
                            <div class="mb-3">
