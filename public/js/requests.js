function openRequestModal(type, id) {
    ...
    fetch(`/Head/requests/${type}/${id}`, {
        ...
        .then((data) => {
            ...
            document.getElementById("modal-requested-at").textContent =
                data.requested_at;
            ...
            .then((data) => {
                ...
                data.data.forEach((req) => {
                    ...
                    <div class="table-card">
                        ...
                        <img src="${req.profile_image 
    ? imageBase + '/' + req.profile_image 
    : defaultImage}" 
    alt="Profile" 
    class="profile-thumb">


        ${req.parent_name || "N/A"}</div>
                        <div class="table-col requested-at">${
                            req.requested_at_display ?? req.requested_at
                        }</div>
                        ...
                        <div class="table-col actions">
                            <a href="#" class="review-btn" data-type="${
                                req.type
                            }" data-id="${req.id}">View</a>
                        </div>
                    </div>
                `;
                });
